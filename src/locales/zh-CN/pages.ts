export default {
  ...
  'pages.operation.batchDelete': '批量删除',
  ...
  'pages.deleteSelectedDialog.title': '确认删除选中么?',
  ...
  'pages.message.includeAllChildren':'包含所有子节点',
  'pages.message.delete.errorReason': '删除失败的原因为：',
  'pages.message.api.errorReason': '调用接口失败的原因为：',
  'pages.message.add.success': '新增成功!',
  'pages.message.edit.success': '编辑成功!',
  // 属性的字段名
  ...
  'pages.fieldName.asset.accuracyOfInsensitiveUnlocking': '无感解锁精度(单位厘米)',
  'pages.fieldName.asset.raletiveMaterialByAssetType': '使用资产类别关联物料',
  // 资产类别
  ...
  'pages.modal.AlarmLogic.fieldName.createTask.taskGroupName': '作业组',
  'pages.modal.AlarmLogic.fieldName.createTask.taskGroupNameAfterModify': '修改后作业组名称',
  'pages.modal.AlarmLogic.fieldName.createTask.taskGroupDescriptionAfterModify': '修改后作业组描述',
  'pages.modal.AlarmLogic.fieldName.createTask.taskStandard': '作业规范',
  'pages.modal.AlarmLogic.fieldName.createTask.taskGroupDuration': '作业组时长(分钟)',
  // 报警级别
