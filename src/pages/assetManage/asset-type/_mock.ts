...
const getOneAssetTypeProperties = (req: Request, res: Response) => {
  const data: AssetTypePropertyItem[] = [{
    ...
    RelatedResponseItem: { ID: '18d73844-ebbd-4a3c-af7a-0af21e8aa7a1', Name: null },
    SN: 1,
    ValueFormat: "",
    ValueType: 0,
    CurrentValue: '48d73844-ebbd-4a3c-af7a-0af21e8aa7a8'
  }, {
    DefaultValue: "123",
    Description: "",
    GroupName: "基本信息",
    ...
    RelatedAssetType: { ID: 'a33567c2-2193-4db2-a219-efee78dcc5f8', Name: null },
    RelatedEngineeringUnit: { ID: '00000000-0000-0000-0000-000000000000', Name: null },
    RelatedResponseItem: { ID: '28d73844-ebbd-4a3c-af7a-0af21e8aa7a1', Name: null },
    SN: 1,
    ValueFormat: "",
    ValueType: 3,
  }, {
    DefaultValue: '[{"ID":"38d73844-ebbd-4a3c-af7a-0af21e8aaaa8","Name":"鼠标"},{"ID":"38d73844-ebbd-4a3c-af7a-0af21e8abaa8","Name":"键盘"}]',
    Description: "",
    GroupName: "基本信息",
    ID: "资产类别属性005",
    Invisible: false,
    ...
    RelatedAssetType: { ID: 'a33567c2-2193-4db2-a219-efee78dcc5f8', Name: null },
    RelatedEngineeringUnit: { ID: '00000000-0000-0000-0000-000000000000', Name: null },
    RelatedResponseItem: { ID: '38d73844-ebbd-4a3c-af7a-0af21e8aa7a1', Name: null },
    SN: 1,
    ValueFormat: "",
    ValueType: 7,
    CurrentValue: ''
